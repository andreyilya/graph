...
<div class="atmosphere">
    ...
    <div class="form5wrapper" style="background: rgba(255,255,255,0.7);">
        ...
        <div class="form-sub-title" >+ получите ORGA LINE в подарок!</div>
        <!--cforms name="order-form"-->
        <div style="margin-bottom: 15px;text-align: center;font-weight: bold;font-size: 14px;">До конца акции осталось</div>
        <div class="back-clock-top" data-date="31-05-2014"></div>
    </div>
</div>
